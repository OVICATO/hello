<?php
ob_start();
$API_KEY = "5134157721:AAFiB2TclfQ1bUdzxZ2YE_DVl3JX4BpOHHg";//توكنك
$buy = "@OVICATO";// معرفك
$sudo = "1415298117";//ايديك
$admin = "$sudo";// ماتغير شي
$idBot = "5134157721";// ايدي بوتك
$admmm = $sudo;//ماتغير شي
$Dev = array("$sudo", "" );
$userrr = "iron4bot";// معرف بوتك بدون @
...
$Dev = array("$admmm","1415298117");// حط ايدي مطور ثاني بدل الاصفار
$channel = "D_C_Y";
$token = API_KEY;
...
file_put_contents("SudoOrders/namebot.txt","بيسو");
bot("sendMessage",["chat_id"=>$chat_id,'text'=>"⌔︙اهلا عزيزي » [$info](tg://user?id=$from_id) \n⌔︙ارسل اسم البۄت الان \n ✓",'parse_mode'=>"MARKDOWN",'reply_to_message_id'=>$message_id,]);}}
...
$botproxre = array("صيحولي بيسو كافي بوت 😒🔪","لتكول بوت اسمي بيسو 😒🔪","عندي اسم تره 😒💔","انت البوت لك 😒💔");
...
$proxre = array("😸♥️ هلا كلبي وياك بيسو تفضل","ترةه مصختهاا احجيي شرايد 😕😒💔","اطلقق واحدد يصيح بيسو 😻♥️","خبصتت امنةة شتريدد عااد 🤧😒💔");
$reprox = array_rand($proxre, 1);
if($text == "بيسو" and $namebot == NULL){
if ($tc == 'group' | $tc == 'supergroup'){
...
bot('sendmessage',['chat_id'=>$chat_id,'text'=>"⌔︙مرحبا انا بوت اسمي بيسو
⌔︙[اضغط هنا الصنع بوت مجاني حمايه](t.me/Pesos1bot)
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"⌔︙*اهلا بك مجددا عزيزي المطور *\n⌔︙*اليك الازرار الخاصه بتعديل وتغيير كلايش سورس بيسو فقط اضغط على الامر الذي تريد تنفيذه*",
'parse_mode'=>'MarkDown',
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
'inline_keyboard'=>[
[
['text'=>"$dataadd",'url'=>"https://t.me/BESSO500K"]
],
]
])
]);
...
⌔︙[ اضغط هنا لديك مفاجئه ](https://t.me/BESSO500K)",'parse_mode'=>"MARKDOWN",'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id, ]);}
...
bot("sendmessage",[
'chat_id'=>$chat_id,
'text'=>"► : هلان بك في سورس بيسو المجاني
",
'parse_mode'=>'markdown',
'disable_web_page_preview'=>true,
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>'❤️اضغط هنا الصنع بوت حمايه','url'=>"t.me/Pesos1bot"]],
[['text'=>'💘اضغط هنا الصنع اي بوت مجاني','url'=>"t.me/i7l_BOT"]],
[['text'=>'🕵‍♀قناة السورس وتحديثات','url'=>"t.me/BESSO500K"]],
[['text'=>'👨‍💻مطور السورس','url'=>"t.me/Jll_il"]],
]
])
]); 
} 
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'⌔︙تابع قناة السورس','url'=>'https://t.me/BESSO500K']],]])]);}}}
...
'السورس عاوي' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','سورس عاوي' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','السورس زربه' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','سورس بيسو' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','سورس بيسو' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','سورس عبس' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪',
...
$fast = array('⌔︙اسرع واحد يرسل { عباس } يربح','⌔︙اسرع واحد يرسل { بغداد } يربح','⌔︙اسرع واحد يرسل { قناة } يربح','⌔︙اسرع واحد يرسل { بيسو } يربح','⌔︙اسرع واحد يرسل { رمضان } يربح','⌔︙اسرع واحد يرسل { لابتوب } يربح','⌔︙اسرع واحد يرسل { كمبيوتر } يربح','⌔︙اسرع واحد يرسل { تلفون } يربح','⌔︙اسرع واحد يرسل { مطبخ } يربح','⌔︙اسرع واحد يرسل { اليمن } يربح','⌔︙اسرع واحد يرسل { سوريا } يربح','⌔︙اسرع واحد يرسل { العراق } يربح','⌔︙اسرع واحد يرسل { السعوديه } يربح','⌔︙اسرع واحد يرسل { مصر } يربح','⌔︙اسرع واحد يرسل { السودان } يربح');
...
if(in_array($chat_id,$game1) and $text == 'كمبيوتر' or $text == 'عباس'  or $text == 'اليمن'  or $text == 'مصر'  or $text == 'السودان'  or $text == 'سوريا' or  $text == 'العراق' or $text == 'رمضان' or $text == 'لابتوب' or $text == 'تلفون' or $text == 'بيسو' or $text == 'قناة' or $text == 'بغداد' or $text == 'مطبخ'){
if($level == "gamew"){
$game['game'][$chat_id][$from_id] = ($game['game'][$chat_id][$from_id]+1);
file_put_contents('game.json', json_encode($game));
file_put_contents("data/$chat_id/game.txt","");
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>'❤️اضغط هنا الصنع بوت حمايه','url'=>"t.me/م1"]],
]
])
]); 
}}}}}
...
if($text == 'سلام'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ متبقاش تقطع الجوبات..😂💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == '😔'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍متزعلش بحبك..😥♥️", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'سلام عليكم'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍وعليكم السلام ..🖤🌚", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'فتح المحن'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍اهلا عزيزي تم فتح المحن بنجاح", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'قفل المحن'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍اهلا عزيزي تم قفل المحن بنجاح اتمحونوا بف عشان المراره 😹◉", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'حصل خير'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ يتي كبرت وبقيت بتشبك الكلام..🥺💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'انتي مين'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ انا وحده نسوان ونت مين..😂💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'كسمك'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ عيب ياوسخ..🙄💔", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'دا بوت'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ احيه هو كان مفكرني انسان ولا اي..😹💜", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'متيجي'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ تؤ تعاله انته..🥺💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'متيقي'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ هتخدها فين ياوسخ..🙄💔", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == '😳'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ احيه..😳", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'الخير'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍انت الخير ياعمري..❤️", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'النبي'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍عليه الصلاه والسلام..💛🙂", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'بكرهك'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ ونا والله مش طايقك..😒💔", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'عامل اي'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ عامل جمعيه..🙄💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'خاص'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍خاص اي ياض انت وهو عييب😂💔", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'هاي' || $text == 'هااي'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍خالتك جريت وراي..😹✋", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'باي' || $text == 'بيي'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ باي ياحته مني..🥺💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'طيب' || $text == 'تيب'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍فرح خالتك قريب..😂♥️", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'شكرا' || $text == 'ميرسي'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ العفو ياروحي..🌚💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'هلو' || $text == 'هلا'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ هلا بيك ياروحي..💛", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'تمم' || $text == 'تمام'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ دايما ياحبيبي..🌚💜", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'حصل' || $text == 'حصل😂'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ محصلش بطل تطبيل..🙄💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'بحبك' || $text == 'حبق'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ بعشء امك..🥺💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == '🙄🙄' || $text == '🙄🙄🙄'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ سقف الجروب عاجبك..😂💜", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == '😒😒' || $text == '😒😒😒'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ افرد وشك المعفن ده..😑💔", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'دي' || $text == 'ده'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ لا مش هي دي..😹🔥", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'بف' || $text == 'برايفت'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ خدوني طيب..😪💔", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == '😂😂😂' || $text == '😂😂😂😂'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ دامت ضحكتك يابيبي..🥺💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'اخرصي' || $text == 'اخرص'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ هات لازقه احطها ع بوقي..😹♥️", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'فين الادمن' || $text == 'الادمن فين'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ فلخاص بيخصخص..😂💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'تعال خاص' || $text == 'تعالى خاص'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍خاص اي ياض انت وهو عييب😂💔", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'بتحبني' || $text == 'حبيبي'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ بدمنك ياحبيبي..🥺♥️", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'شش' || $text == 'ششش'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ بنهش كتاكيت احنا هنا ولا اي..🐣😹", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'خلاص' || $text == 'خلص'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ خلصت روحك يابعيد..😹💔", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'جيت' || $text == 'انا جيت'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ نورت يارئيس اركان قلبي..🥺💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'نعم' || $text == 'يانعم'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ مين مؤدب ناوو..😹💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == '🙂🙂' || $text == '🙂💔'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍  أنت هتنكد لي طيب..🥺💔", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'اسلام عليكم' || $text == 'السلام عليكم'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"عليكم السلام ورحمة الله وبركاتة❤🥰", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == '😹😹😹' || $text == '😹😹😹'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ بتضحك علي خيبتك..🙄💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'قلبي' || $text == 'ياقلبي'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ تنشك في قلبك بتخوني..🙄💔", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'بتعمل اي' || $text == 'بتعملي اي'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ وأنت مالك ياحشري..🙄💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'انتا مين' || $text == 'مين'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ انا بوت وبحبك..🥺💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'البوت واقف' || $text == 'البوت وقف'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ لا انا شغال متحورش..😒💔", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'فين' || $text == 'انت فين'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ هنا فقلبي..😹♥️", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'اوف' || $text == 'يوه'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ يتي القمر زعلان من اي..🥺🔥", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'بخ' || $text == 'عو'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ يوه خضتني ياسمك اي..🥺💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'احا' || $text == 'احااا'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ بالتكت بتعها..🙄💔", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'بعشقك' || $text == 'بموت فيك'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ بدمنك ياعيوني..🥺💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'عيب' || $text == 'لا عيب'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ سيب الواد يلعب..🙄💛", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'هه' || $text == 'ههه'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ ضحكه مش سالكه زيك..😹💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'تؤ' || $text == 'تؤ تؤ'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"◍ يانوحي يانوحي..🥺💘", 'reply_to_message_id'=>$message->message_id, ]); }
if($text == 'حلوه' || $text == 'حلو'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"يحلات عيونك..♥️🦋", 'reply_to_message_id'=>$message->message_id, ]); }
...
if($text == 'لو' || $text == 'هو'){ bot('sendMessage',[ 'chat_id'=>$chat_id,'message_id'=>$message_id,  'text'=>"سورس توسونامي واكل الجو", 'reply_to_message_id'=>$message->message_id, ]); }
...
bot('sendMessage',['chat_id'=>$chat_id,'text'=>"جاري تحديث سورس بيسو ►︙",'parse_mode'=>"MARKDOWN",'reply_to_message_id'=>$message->message_id,]);
sleep(1);
